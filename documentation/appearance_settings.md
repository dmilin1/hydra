...
**Show Subreddit Icons**: Displays custom subreddit icons. Uses additional data.

**Post Title Max Lines**: Limits title length from 1 to 10 lines to keep post cards uniform.

**Post Text Max Lines**: Limits displayed post text from 0 to 10 lines. Set to 0 to hide text previews entirely.

**Link Description Max Lines**: Limits link preview descriptions from 0 to 30 lines. Applies to external link posts.

**Show Post Flairs**: Displays post flairs (subreddit-specific category tags).

**Blur Spoilers**: Automatically blurs spoiler-tagged content. Tap to reveal.

**Blur NSFW**: Automatically blurs NSFW content. Tap to reveal.
...
**Mute Videos by Default**: Starts full-screen videos muted. Unmuting applies to all videos until Hydra leaves the foreground.
...
Configure appearance in [Appearance settings](hydra://settings/appearance), or learn about [Themes](hydra://settings/guide/?doc=themes) for color and theme customization.
