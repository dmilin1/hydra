...
Inbox Alerts are enabled by default for Hydra Pro subscribers. When you first subscribe to Pro, the app will ask you to grant notification permission. Once granted, you'll start receiving push notifications automatically.
...
You'll receive push notifications for new items in your inbox:
...
Inbox Alerts is a [Hydra Pro](hydra://settings/guide/?doc=hydra_pro) feature. Learn about the [Inbox](hydra://settings/guide/?doc=inbox) or [subscribe to Pro](hydra://settings/hydraPro).
