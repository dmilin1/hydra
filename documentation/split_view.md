...
Tap any post in your feed to open it in the right panel. The feed remains on the left, and you can scroll each panel independently. Tap a different post to switch what's shown on the right.

At the bottom of the right panel, two buttons appear:

- **Close** -- Closes the right panel and returns to the feed-only view.
- **Fullscreen** -- Opens the current post in full-screen mode.

All standard post interactions (voting, commenting, saving, sharing) work normally in split view.
