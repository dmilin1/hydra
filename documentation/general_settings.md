...
description: Startup settings (initial tab, startup URL), Open in Hydra (shortcut setup, clipboard detection), Legal (Privacy Policy, EULA), External Links (browser selection), Gestures, Sorting, Filters
===END METADATA===
...
**Hydra Shortcut**: Adds "Open in Hydra" to iOS share sheets. Tap "Get Hydra Shortcut" in [Open in Hydra settings](hydra://settings/general/openInHydra) to install via the iOS Shortcuts app. Once installed, "Open in Hydra" appears in share menus from any app.

**Read Links from Clipboard**: Automatically detects Reddit links in your clipboard when the app opens and offers to open them. To avoid repeated permission prompts, go to iOS Settings > Hydra > "Paste from Other Apps" and set to "Allow".

Learn more in the [External Links guide](hydra://settings/guide/?doc=external_links).

## Legal Settings

Access Privacy Policy and End User License Agreement (EULA) links in [Legal settings](hydra://settings/general/legal). These open in your browser.
