...
export default function DataUse() {
  ...
  const { dataModeSettings, changeDataModeSetting } = useContext(DataModeContext);
  ...
  return <>
      ...
      items={[
        {
          ...
          rightIcon: (
            <Switch
              ...
              onValueChange={value => changeDataModeSetting('wifi', value ? 'lowData' : 'normal')}
            />
          ),
        ...
        },
        {
          ...
          rightIcon: (
            <Switch
              ...
              onValueChange={value => changeDataModeSetting('cellular', value ? 'lowData' : 'normal')}
            />
          ),
    ...
    />
    <Text style={t(styles.textDescription, {
      color: theme.text,
    })}>
      Low data mode reduces the quality and amount of media that gets loaded when
      scrolling. For example, videos will not be loaded while scrolling and will
      only load when they are clicked on.
    </Text>
  </>;
}
